  ...
  return (
    <div className="md:hidden">
      <button
        ...
        className="rounded-xl border border-white/15 px-3 py-2 text-sm font-bold text-white hover:bg-white/10"
      ...
      {isOpen ? (
        <div className="absolute left-4 right-4 top-20 z-50 overflow-hidden rounded-2xl bg-white text-[#0D1B2A] shadow-2xl ring-1 ring-[#DBE4EE]">
          {userLabel ? (
